    ...
    void Runtime::f_updateColliders(RType::Runtime::ECS::Entity entity, const std::string &path)
    {
        ...
        for (auto &e : m_entities) {
            ...
            SKIP_EXCEPTIONS({
                ...
                if (t1.position.x - collisionBox.width / 2 <
                        t2.position.x + collisionBox2.width / 2 &&
                    t1.position.x + collisionBox.width / 2 >
                        t2.position.x - collisionBox2.width / 2 &&
                    t1.position.y - collisionBox.height / 2 <
                        t2.position.y + collisionBox2.height/ 2 &&
                    t1.position.y + collisionBox.height / 2 >
                        t2.position.y - collisionBox2.height / 2) {
