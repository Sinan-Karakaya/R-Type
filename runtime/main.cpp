...
struct position {
    ...
    static position from_tuple(const tuple_type& tuple) {
...
class luaType
{
    ...
    private:
        /*
            ...
            ** it adds to all the previous parameters "..." the current parameter "std::get<Is>(tuple) = sol::stack::get<int>(L, index + Is)" 
        */
        /*
        ...
        */
        ...
        /* 
            ...
            ** - std::make_index_sequence<num_params> is used to generate a sequence of indices, in this case 0, 1, 2, ..., num_params - 1
        */
...
class LuaApi {
    public:
        ...
        void registerType(const std::string& name) {
            lua.new_usertype<T>(name.c_str(), sol::constructors<T(int, int)>(),
                "to_tuple", &T::to_tuple,
                "from_tuple", &T::from_tuple);
        }
