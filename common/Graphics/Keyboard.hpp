    ...
    public:
        ...
        struct Scan {
            enum Scancode {
                ...
                // Typical language mappings: Belg:£µ` FrCa:<>} Dan:*' Dutch:`´ Fren:µ* Ger:'# Ital:§ù LatAm:[}` Nor:*@
        ...
        typedef Keyboard::Scan::Scancode Scancode;

        virtual bool IsKeyPressed(Key key) = 0;
        virtual bool IsKeyPressed(Scancode key) = 0;
    };
} // namespace RType::Graphics
